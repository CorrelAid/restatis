...
restatis is a wrapper around the RESTful API that provides access to the [GENESIS databases of the Federal Statistical Office of Germany (Destatis)](https://www-genesis.destatis.de/).
...
restatis provides functions (prefixed with `gen_`) for finding, exploring, and retrieving data from the GENESIS API. See the ["Basic restatis workflow" vignette](https://correlaid.github.io/restatis/articles/restatis.html) for an overview of the main features of the package.
