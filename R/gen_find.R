...
#'
#' @description Function to search through the databases. It is similar in usage as the search function on the main page.
...
#' @param category Character string. Specify specific object types ('tables', 'statistics' and 'cubes') and specific Zensus 2022 object types ('tables' and 'statistics'). All types that are specific for one database can be used together. Default option is to use all types that are possible for the specific database.
        ...
        if (!is.null(results_json$Tables)) {
          ...
          if (isTRUE(detailed)) {
            ...
            if (nrow(df_table) != 0) {
              ...
              df_table$Titel <- title_search(df_table, term, text = verbose)
        ...
        if (!is.null(results_json$Statistics)) {
          ...
          if (isTRUE(detailed)) {
            ...
            if (nrow(df_stats) != 0) {
              ...
              df_stats$Titel <- title_search(df_stats, term, text = verbose)
        ...
        if (!is.null(results_json$Variables)) {
          ...
          if (isTRUE(detailed)) {
            ...
            if (nrow(df_variables) != 0) {
              ...
              df_variables$Titel <- title_search(df_variables, term, text = verbose)
          ...
          if (!is.null(results_json$Cubes)) {
            ...
            if (isTRUE(detailed)) {
              ...
              if (nrow(df_cubes) != 0) {
                ...
                df_cubes$Titel <- title_search(df_cubes, term, text = verbose)
