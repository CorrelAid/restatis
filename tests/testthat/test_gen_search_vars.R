...
test_that("gen_search_vars function errors on multiple codes", {
  ...
  expect_error(object = gen_search_vars(code = c("611*", "711*"),
                                        detailed = TRUE,
                                        category = "tables"),
...
test_that("gen_search_vars function errors on numeric code param", {
  ...
  expect_error(object = gen_search_vars(code = 12345,
                                        detailed = TRUE,
                                        category = "tables"),
...
test_that("gen_search_vars function errors on wrong sort param", {
  ...
  expect_error(object = gen_search_vars(code = "61111",
                                        sortcriterion = "date"),
...
test_that("gen_search_vars function errors on wrong sort param type", {
  ...
  expect_error(object = gen_search_vars(code = "6111*",
                                        sortcriterion = 123),
...
test_that("gen_search_vars function errors on wrong error.ignore param", {
  ...
  expect_error(object = gen_search_vars(code = "711*",
                                        error.ignore = 1),
