...
test_that("gen_objects2var function errors on multiple codes", {
  ...
  expect_error(object = gen_objects2var(code = c("DLAND", "LAND"),
                                        detailed = TRUE,
                                        category = "tables"),
...
test_that("gen_objects2var function errors on numeric code param", {
  ...
  expect_error(object = gen_objects2var(code = 12345,
                                        detailed = TRUE,
                                        category = "tables"),
...
test_that("gen_objects2var function errors on wrong categories", {
  ...
  expect_error(object = gen_objects2var(code = "DLAND",
                                        detailed = TRUE,
                                        category = "variables",
                                        database = "genesis"),
...
test_that("gen_objects2var function errors on too many categories", {
  ...
  expect_error(object = gen_objects2var(code = "611*",
                                        detailed = TRUE,
