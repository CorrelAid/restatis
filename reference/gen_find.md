...
- term:
  ...
  A character string with no maximum character length, but a word limit
  of five words.
...
- ordering:
  ...
  A logical. Indicator if the function should return the output of the
...
- error.ignore:
  ...
  response. Default option is 'TRUE'. Important note: This does not
